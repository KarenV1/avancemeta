document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        es: {
            ...
            service_3_desc: "Soluciones digitales responsivas y escalables para su negocio.",
            ...
            bio_why_text: "Experiencia en diseño computacional de fármacos, modelado molecular y bioinformática de productos naturales. <br> Análisis listos para publicación en revistas, tesis e informes de la industria. <br> Entrega rápida, alta precisión y flujos de trabajo de proyectos personalizables. <br> Ideal para estudiantes, universidades, empresas biotecnológicas y laboratorios de investigación.",
            ...
            web_tagline: "Soluciones digitales responsivas y escalables para su negocio.",
            web_about_title: "Sobre este servicio",
            web_about_text: "En Meta Scientia, creamos experiencias digitales excepcionales. Nuestro equipo de desarrollo web se especializa en construir sitios web y aplicaciones modernas, responsivas y escalables que impulsan el crecimiento de su negocio y fortalecen su presencia en línea.",
            web_offer_title: "¿Qué ofrecemos?",
            web_feat_1: "Diseño Responsivo y Moderno",
            web_feat_1_desc: "Sitios web que se ven y funcionan perfectamente en todos los dispositivos, desde móviles hasta escritorio.",
            web_feat_2: "Desarrollo Escalable",
            web_feat_2_desc: "Arquitecturas robustas diseñadas para crecer con su negocio, utilizando las últimas tecnologías.",
            web_feat_3: "Optimización SEO",
            web_feat_3_desc: "Mejoramos su visibilidad en los motores de búsqueda para atraer más tráfico orgánico.",
            web_feat_4: "Soluciones Personalizadas",
            web_feat_4_desc: "Desarrollo a medida para satisfacer las necesidades específicas de su proyecto o empresa.",
            web_feat_5: "Comercio Electrónico",
            web_feat_5_desc: "Tiendas en línea seguras y fáciles de administrar para vender sus productos al mundo.",
            web_benefits_title: "Beneficios",
            web_benefits_text: "Transformamos sus ideas en realidad digital. Un sitio web profesional no solo mejora su imagen de marca, sino que también es una herramienta poderosa para la adquisición y retención de clientes.",
            web_portfolio_title: "Vea Nuestro Trabajo",
            web_portfolio_desc: "Explore nuestro portafolio para ver ejemplos de proyectos exitosos.",
            web_portfolio_btn: "Ver Portafolio"
        },
        en: {
            nav_home: "Home",
            ...
            service_3_desc: "Responsive and scalable digital solutions for your business.",
            ...
            bio_why_text: "Expertise in computational drug design, molecular modeling, and natural product bioinformatics. <br> Analyses ready for journal publication, theses, and industry reports. <br> Fast delivery, high accuracy, and customizable project workflows. <br> Ideal for students, universities, biotech companies, and research labs.",
            ...
            web_tagline: "Responsive and scalable digital solutions for your business.",
            web_about_title: "About this service",
            web_about_text: "At Meta Scientia, we create exceptional digital experiences. Our web development team specializes in building modern, responsive, and scalable websites and applications that drive business growth and strengthen your online presence.",
            web_offer_title: "What do we offer?",
            web_feat_1: "Responsive & Modern Design",
            web_feat_1_desc: "Websites that look and function perfectly on all devices, from mobile to desktop.",
            web_feat_2: "Scalable Development",
            web_feat_2_desc: "Robust architectures designed to grow with your business, using the latest technologies.",
            web_feat_3: "SEO Optimization",
            web_feat_3_desc: "We improve your visibility on search engines to attract more organic traffic.",
            web_feat_4: "Custom Solutions",
            web_feat_4_desc: "Tailored development to meet the specific needs of your project or company.",
            web_feat_5: "E-commerce",
            web_feat_5_desc: "Secure and easy-to-manage online stores to sell your products to the world.",
            web_benefits_title: "Benefits",
            web_benefits_text: "We transform your ideas into digital reality. A professional website not only improves your brand image but is also a powerful tool for customer acquisition and retention.",
            web_portfolio_title: "View Our Work",
            web_portfolio_desc: "Explore our portfolio to see examples of successful projects.",
            web_portfolio_btn: "View Portfolio"
        }
    };
